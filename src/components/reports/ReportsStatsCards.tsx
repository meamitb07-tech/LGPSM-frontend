    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-white border border-gray-200 rounded-md p-5 shadow-2xs relative space-y-3">
        <div className="flex items-center justify-between">
          ...
          <svg className="w-4 h-4 text-gray-400 absolute top-5 right-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
          </svg>
        </div>
        <div>
          <h3 className="text-3xl font-bold text-gray-900 tracking-tight">510</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-md p-5 shadow-2xs relative space-y-3">
        ...
        <div>
          <h3 className="text-3xl font-bold text-gray-900 tracking-tight">436</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-md p-5 shadow-2xs relative space-y-3">
        ...
        <div>
          <h3 className="text-3xl font-bold text-gray-900 tracking-tight">14</h3>
