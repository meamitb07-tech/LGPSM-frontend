...
export default function Sidebar({ activeItem: propActiveItem }: SidebarProps) {
  ...
  return (
    <aside className="w-64 bg-[#14161A] text-gray-300 flex flex-col justify-between shrink-0 hidden md:flex h-screen sticky top-0 overflow-y-auto overscroll-contain no-scrollbar p-4 font-sans select-none z-30">
