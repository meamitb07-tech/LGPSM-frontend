    ...
    <>
      <div className="flex items-center gap-3">
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-1.5 bg-[#FF5B22] hover:bg-[#E04B16] text-white rounded-full text-xs font-bold transition-all shadow-xs cursor-pointer shrink-0"
        >
        ...
        <div className="relative inline-block text-left" ref={dropdownRef}>
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#F1F3F6] hover:bg-[#E4E7EC] px-3 py-1.5 rounded-full cursor-pointer transition-all duration-150 focus:outline-none select-none"
          >
