          ...
          {activeTab === "templates" ? (
            ...
            <div className="p-8 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50 flex flex-col items-center justify-center text-center">
              <p className="text-xs text-gray-600 mb-2">
                Drag and drop a photo here or <span className="text-[#FF5B22] font-semibold underline cursor-pointer">click</span> to open file
              </p>
              <ul className="text-[11px] text-gray-400 space-y-1 mt-4 text-left list-disc list-inside">
