            ...
            <div className="w-full md:w-1/2 p-8 sm:p-10 flex flex-col justify-center bg-white">
              ...
              <Link href="/events/add" className="block group">
                <ul ref={listRef} className="space-y-4 text-xs sm:text-sm font-semibold text-gray-800">
                  {/* 1. Create an event */}
                  <li className="flex items-center gap-3 group-hover:text-[#FF5B22] transition-colors">
                ...
                <div className="mt-6">
                  <span className="inline-flex items-center justify-center py-2.5 px-5 bg-[#FF5B22] hover:bg-[#E04B16] text-white font-bold text-xs rounded-lg transition-all shadow-xs cursor-pointer">
                    Start Creating Event &rarr;
                  </span>
                </div>
              </Link>
            </div>
