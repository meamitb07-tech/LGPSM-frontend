        ...
        <nav className="space-y-1 text-xs font-medium pt-1">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className={activeItem === "dashboard" ? "text-[#FF5B22]" : ""}>Dashboard</span>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              <svg className={`w-4 h-4 ${activeItem === "configurations" ? "text-[#FF5B22]" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className={activeItem === "configurations" ? "text-[#FF5B22]" : ""}>Configurations</span>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              <svg className={`w-4 h-4 ${activeItem === "user-management" ? "text-[#FF5B22]" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
              <span className={activeItem === "user-management" ? "text-[#FF5B22]" : ""}>User Management</span>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-3">
              <svg className={`w-4 h-4 ${activeItem === "billing" ? "text-[#FF5B22]" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span className={activeItem === "billing" ? "text-[#FF5B22]" : ""}>Billing</span>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className={activeItem === "reports" ? "text-[#FF5B22]" : ""}>Reports</span>
            </div>
            <svg className="w-3.5 h-3.5 text-gray-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
            </svg>
          ...
          >
            <div className="flex items-center gap-3">
              <svg className={`w-4 h-4 ${activeItem === "settings" ? "text-[#FF5B22]" : "text-gray-400"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
              </svg>
              <span className={activeItem === "settings" ? "text-[#FF5B22]" : ""}>Settings</span>
            </div>
          </div>
        </nav>
      </div>
