    ...
    <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6 font-sans text-xs">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          {logoFile ? (
            <div className="p-2.5 border border-emerald-200 rounded-lg bg-emerald-50/50 flex items-center justify-between min-h-[76px]">
              <div className="flex items-center gap-3 overflow-hidden">
                {logoFile.url.startsWith("blob:") || logoFile.url.startsWith("data:") ? (
                  <div className="w-10 h-10 rounded overflow-hidden relative shrink-0 border border-emerald-300">
                ...
                <span className="text-xs font-semibold text-emerald-900 truncate max-w-[150px] sm:max-w-[200px]">
                  {logoFile.name}
                </span>
              </div>
              <button
            ...
            <div
              ...
              className="p-4 border-2 border-dashed border-gray-200 rounded-lg bg-gray-50/60 text-center flex items-center justify-center min-h-[76px] hover:bg-gray-100/70 hover:border-gray-300 transition-colors cursor-pointer select-none"
            >
